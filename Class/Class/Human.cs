...
namespace @class
{
    ...
    class Human
    {
        ...
        public Human()
        {
            Console.WriteLine("Создание человека");
            this._name = "Dmitry";
            this._surname = "Mishchenko";
            this._age = 18;
            this._height = 1.86;
            this._habbits = false;
        ...
        public Human(string name, string surname, int age, double height, bool habbits, Nation nation, Adress adress)
        {
            this._name = name;
